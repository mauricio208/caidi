...
export default {
  ...
  data: ()=> ({
    equipo:[
      ...
      {id: 5, nombre: 'Hilvic Garcia', rol:'Terapeuta Ocupacional', descripcion:'Diplomado en autismo Universidad Monteavila, Instructora certificada en masaje infantil, Certificación en Integración Sensorial', avatar:require('@/assets/images/quienesomos/hilvic.jpeg')},
    ],
    carouselImages: [
